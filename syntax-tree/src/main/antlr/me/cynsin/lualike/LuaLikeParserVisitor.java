...
public interface LuaLikeParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * labeled alternative in {@link LuaLikeParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEmptyStatement(LuaLikeParser.EmptyStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAssignmentStatement(LuaLikeParser.AssignmentStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLabelStatement(LuaLikeParser.LabelStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBreakStatement(LuaLikeParser.BreakStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGotoStatement(LuaLikeParser.GotoStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDoStatement(LuaLikeParser.DoStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWhileStatement(LuaLikeParser.WhileStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRepeatStatement(LuaLikeParser.RepeatStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIfStatement(LuaLikeParser.IfStatementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code NumericForStatement}
	 * labeled alternative in {@link LuaLikeParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNumericForStatement(LuaLikeParser.NumericForStatementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code GenericForStatement}
	 * labeled alternative in {@link LuaLikeParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGenericForStatement(LuaLikeParser.GenericForStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionStatement(LuaLikeParser.FunctionStatementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code LocalFunctionStatement}
	 * labeled alternative in {@link LuaLikeParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLocalFunctionStatement(LuaLikeParser.LocalFunctionStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLocalVariableDeclarationStatement(LuaLikeParser.LocalVariableDeclarationStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExpressionStatement(LuaLikeParser.ExpressionStatementContext ctx);
	/**
	 ...
	 * labeled alternative in {@link LuaLikeParser#object}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectDeclaration(LuaLikeParser.ObjectDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by the {@code InlineObjectDeclaration}
	 * labeled alternative in {@link LuaLikeParser#object}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInlineObjectDeclaration(LuaLikeParser.InlineObjectDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link LuaLikeParser#objectAttributes}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectAttributes(LuaLikeParser.ObjectAttributesContext ctx);
	/**
	 * Visit a parse tree produced by {@link LuaLikeParser#functionObjectEntry}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionObjectEntry(LuaLikeParser.FunctionObjectEntryContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LuaLikeParser#reference}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReference(LuaLikeParser.ReferenceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIndexExpression(LuaLikeParser.IndexExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMemberExpression(LuaLikeParser.MemberExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallStatement(LuaLikeParser.FunctionCallStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitReferenceExpression(LuaLikeParser.ReferenceExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitObjectExpression(LuaLikeParser.ObjectExpressionContext ctx);
	/**
